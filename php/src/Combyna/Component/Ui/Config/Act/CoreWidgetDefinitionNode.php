...
use Combyna\Component\Ui\CoreWidgetDefinition;
use Combyna\Component\Validator\Context\ValidationContextInterface;

/**
 * Class CoreWidgetDefinitionNode
 *
 * @author Dan Phillimore <dan@ovms.co>
 */
class CoreWidgetDefinitionNode extends AbstractActNode implements WidgetDefinitionNodeInterface
{
    const TYPE = CoreWidgetDefinition::TYPE;
