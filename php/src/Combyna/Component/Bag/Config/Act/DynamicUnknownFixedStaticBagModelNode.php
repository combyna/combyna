...
/**
 * Class DynamicUnknownFixedStaticBagModelNode
 *
 * @author Dan Phillimore <dan@ovms.co>
 */
class DynamicUnknownFixedStaticBagModelNode extends AbstractActNode implements FixedStaticBagModelNodeInterface, DynamicActNodeInterface
{
